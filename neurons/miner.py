...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        implementation_files = [
            ...
            repo_root / "poker44_model" / "model_a.joblib",
            repo_root / "poker44_model" / "model_b.joblib",
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            defaults={
                "model_name": "poker44-ensemble-2",
                "model_version": "2.0-blend",
                "framework": "scikit-learn-ensemble",
                "license": "MIT",
                "repo_url": "https://github.com/EmmanuelGreene/poker44-sn126-model-2",
                "notes": "Blended C2 ensemble over identical behavioral features.",
                "open_source": True,
